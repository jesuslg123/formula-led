...
#define SPEAKER1_PIN 9
#define SPEAKER2_PIN 10
...
void playerBeep(int playerId, int playerSpeed) {
  if (playerId == 1) {
    tone1.play(PLAYER1_TONE * playerSpeed, 15);
  } else {
    tone2.play(PLAYER2_TONE * playerSpeed, 15);
  }
}
